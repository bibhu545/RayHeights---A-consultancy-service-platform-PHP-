...
<?php 
  ...
  if (isset($_REQUEST["signup"])) 
  {
      ...
      $sql = "INSERT INTO company_users(company_name,company_email,address,company_phone,password) VALUES('$name','$email','$address','$phone','$password')";
      ...
      {
        header("location:signUp.php?msg=Failed...Try Again.");
      }
  }
          ...
          <div style="padding-left: 20%">
            <form class="form-horizontal">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="email" placeholder="Enter Company Name" name="name" required="required">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group"> 
                <div class="col-sm-offset-2 col-sm-10">
                  <center>
                    ...
                    <a href="index.php" class="btn btn-primary">Have an account?</a>
                  </center>
                  <br>
                </div>
              </div>
